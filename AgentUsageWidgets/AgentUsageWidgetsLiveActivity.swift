...
// Note: This must match AgentUsageLiveActivityAttributes in the main app
...
extension AgentUsageLiveActivityAttributes {
    static var preview: AgentUsageLiveActivityAttributes {
        AgentUsageLiveActivityAttributes(selectedMetric: "Session")
    }
}

extension AgentUsageLiveActivityAttributes.ContentState {
    static var onTrack: AgentUsageLiveActivityAttributes.ContentState {
    ...
    static var warning: AgentUsageLiveActivityAttributes.ContentState {
        AgentUsageLiveActivityAttributes.ContentState(
            percentUsed: 72,
    ...
    static var critical: AgentUsageLiveActivityAttributes.ContentState {
        AgentUsageLiveActivityAttributes.ContentState(
            percentUsed: 92,
            timeUntilReset: "45m",
            statusRaw: "critical"
...
#Preview("Notification", as: .content, using: AgentUsageLiveActivityAttributes.preview) {
    AgentUsageWidgetsLiveActivity()
} contentStates: {
    AgentUsageLiveActivityAttributes.ContentState.onTrack
    AgentUsageLiveActivityAttributes.ContentState.warning
    AgentUsageLiveActivityAttributes.ContentState.critical
}
